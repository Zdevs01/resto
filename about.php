    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <p class="mb-4">
                    GoodFood a commencé son aventure en 2017 et est depuis devenu l'un des restaurants les plus réputés de la ville.
                    Spécialisé à l'origine dans la restauration rapide, nous utilisons uniquement des ingrédients de première qualité 
                    pour préparer nos plats, garantissant ainsi une qualité inégalée.
                </p>
                <p class="mb-4">
                    Nous offrons à nos clients des repas raffinés et une expérience gastronomique exceptionnelle. 
                    Notre ambition est de devenir l'un des restaurants les mieux notés au niveau national, en satisfaisant les palais 
                    les plus exigeants.
                </p>
                    ...
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center border-start border-5 border-primary px-3">
                            ...
                            <div class="ps-4">
                                ...
                                <h6 class="text-uppercase mb-0">de Renommée</h6>
                            </div>
                        </div>
                    </div>
                </div>
